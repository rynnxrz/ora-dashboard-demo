export const TRANSLATIONS = {
    ...
    zh: {
        // Header
        "header_title": "欧拉营养内部流程与客户洞察总览",
        "header_update": "上次更新：2024-11-28 09:00",
        "filter_time_q4": "📅 时间范围：本季度",
        ...
        "zombie_i_sub": "发货逾期超过 7 天",

        // Widget P1-D
        "p1d_title": "数据完整度",
        "p1d_update": "最近更新：10分钟前",
        "p1d_subtitle": "左侧展示整体完整度，右侧展示问题分布。一条记录可能包含多种问题。",
        "p1d_list_title": "问题合同列表",
        "p1d_filter_label": "当前筛选:",
        "p1d_th_contract": "合同/产品",
        "p1d_th_issue": "问题",
        "p1d_th_update": "更新",
        "p1d_empty": "记录完整 · 无需补充",
        ...
        // Part 2
        "p2_title": "第二部分：交付周期深度透视",
        "p2_subtitle": "流程周期对比目标",
        ...
        "p2_breach_title": "各阶段超出内部目标的比例",
        "p2_breach_desc": "主要瓶颈：",
        "p2_breach_b1": "1. 物料准备阶段",
        "p2_breach_b2": "2. 生产阶段",

        "p3_adherence_title": "各产线按时交付情况",
        "p3_adherence_footer": "软糖和胶囊的交付最稳定，粉剂延迟较多。",

        "p4_mat_title": "开工前物料准备情况",
        "p4_mat_desc": "当前约 85% 的生产批次在开工前物料已准备就绪。",
        "p4_mat_risk": "风险批次（开工时物料未完全到位）",

        "g1_title": "工厂产出与效率提升",
        "g1_sub": "季度出货趋势",
        "g1_desc": "第四季度预计出货 120 万件，较上季度增长 15%；平均交付时间比初始阶段缩短约 3 天。",
        ...
        "ct_th_reqs_gacc": "海关注册",
        "ct_th_reqs_code": "喷码",
        "ct_th_reqs_ship": "运输方式",
        "ct_th_reqs_label": "标签",
        "ct_th_reqs_other": "其他",
        ...
        "ct_status_new_1": "新建",
        "ct_status_new_2": "合同",
        "ct_status_pending_1": "待处理",
        "ct_status_pending_2": "准备中",
        "ct_status_ongoing_1": "生产中",
        "ct_status_ongoing_2": "进行中",
        "ct_status_done": "已完成"
    }
};
