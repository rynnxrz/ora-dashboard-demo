    ...
    return (
        <aside className="w-14 flex-shrink-0 flex flex-col z-20 shadow-sm transition-all bg-[#297A88]">
            <div className="h-14 flex items-center justify-center bg-white border-b border-gray-100">
                <img src={slogo} alt="Ora" className="w-10 h-10 object-contain" />
            </div>
            <nav className="flex-1 overflow-y-auto flex flex-col items-center gap-0 bg-[#297A88]">
                ...
                >
                    <img src={vector} alt="Dashboard" className="w-6 h-6" />
                </button>
                {/* Contracts */}
                <button
                ...
                >
                    <img src={contractsIcon} alt="Contracts" className="w-6 h-6 opacity-70 group-hover:opacity-100 transition-opacity" />
                </button>
                {/* Report */}
                <button
                ...
                >
                    <img src={reportIcon} alt="Report" className="w-6 h-6 opacity-70 group-hover:opacity-100 transition-opacity" />
                </button>
                {/* Calendar */}
                <button
                    className="w-full h-14 flex items-center justify-center text-white/70 hover:bg-[#066070]/30 transition-all group"
                >
                    <img src={calendarIcon} alt="Calendar" className="w-6 h-6 opacity-70 group-hover:opacity-100 transition-opacity" />
                </button>
            </nav>
        </aside>
    );
