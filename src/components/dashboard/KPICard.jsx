...
const KPICard = ({
    ...
    return (
        <div
            className={`card p-2 border cursor-pointer hover:shadow-md transition kpi-card relative overflow-hidden ${borderClass} ${isActive ? 'active-filter bg-white shadow-xl ring-2 ring-offset-2 ring-current transform scale-[1.02] z-10' : ''}`}
            id={id}
            onClick={onClick}
        >
